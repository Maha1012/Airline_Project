...
namespace UniversityWebApplnUsingAsp.Net.Respositories.Domain
{
    public class TokenService : ITokenService
    {
        ...
        public ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            //principal
            var principal = tokenHandler.ValidateToken(token, tokenValidationParametes, out securityToken);
